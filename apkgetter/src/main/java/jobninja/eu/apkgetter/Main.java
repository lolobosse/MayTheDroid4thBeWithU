...
public class Main {
     ...
     *
     * @param thirdParty: limit the command to get only third party apps because the system one cannot be extracted without being root
     * @param callback:   callback object to be called when the system is done with the execution of the command.
     */
    public static void getPackages(boolean thirdParty, Callback callback) {
        /*
